...
| 2 | Registry deltas (§3): SN-036, SR-076…SR-080, LLR-081…LLR-085, TC-205…TC-221 | — | `python scripts/trace.py --strict` green, orphans 0; `check.ps1 -Tier Smoke -Gate G2` |
